...
public class T1AdminLoginTrueTest {
  ...
  @Test
  public void T1AdminLoginTrueTest() {
    ...
    driver.findElement(By.id("form-login:username")).sendKeys("Admin");
    driver.findElement(By.id("form-login:password")).sendKeys("Password123");
    driver.findElement(By.id("form-login:submitBtn")).click();
    driver.findElement(By.cssSelector(".title")).click();
    assertThat(driver.findElement(By.cssSelector("h2")).getText(), is("Administrator Menu"));
  }
